...
![CBG Configuration](.gitbook/assets/cbg.png)
...
![Text Quad](.gitbook/assets/text_quad.png)
...
![Text Quad coordinates](.gitbook/assets/text_quad_coords.png)
...
![Orthopgraphic Projections](.gitbook/assets/orthographic_projections.png)
...
![Orthopgraphic Projection Matrix](.gitbook/assets/orthographic_matrix.png)
...
![Orthopgraphic Projection sample](.gitbook/assets/orthographic_projection_sample.png)
...
It will just receive the vertices positions, the texture coordinates, the indices and the normals and will transform them to the 3D space coordinates using a matrix. That matrix is the multiplication of the ortographic projection matrix and the model matrix, . Since we are not doing anything with the coordinates in model space, it’s much more efficient to multiply both matrices in java code than in the shadere. By doing so we will be doing that multipliaztion once per item insted of doing it for each vertex. Remember that our vertices should be expressed in screen coordinates.
...
![Text result](.gitbook/assets/text_result.png)
...
![Text with opaque background](.gitbook/assets/text_opaque.png)
...
![Text with transparent background](.gitbook/assets/text_transparent.png)
...
![Compass](.gitbook/assets/compass.png)
...
![HUD with a compass](.gitbook/assets/hud_compass.png)
...
![Font texture](.gitbook/assets/texture_font.png)
...
![Text rendered improved](.gitbook/assets/text_rendered_improved.png)
