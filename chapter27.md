...
### ![](.gitbook/assets/vao_animation.png)
...
In the animation chapter, we developed a MD5 parser to load animated meshes. In this chapter we will use assimp library. This will allow us to load many more formats besides MD5, such as [COLLADA](https://en.wikipedia.org/wiki/COLLADA), [FBX](https://en.wikipedia.org/wiki/FBX), etc.
...
### ![](.gitbook/assets/mesh_bones_weights_vertices.png)
...
### ![](.gitbook/assets/node_animations.png)
...
![](.gitbook/assets/animation_result.png)
