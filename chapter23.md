...
![Object Picking result](.gitbook/assets/object_picking_result.png)
...
So we need just to perform the traverse the inevrse path to get from screen coordinates , to world coordinates.
