...
![2x2 Matrix](.gitbook/assets/2_2_matrix.png)
...
![Projection Matrix concepts](.gitbook/assets/projection_matrix.png)
...
![Projection Matrix](.gitbook/assets/projection_matrix_eq.png)

Where aspect ratio is the relation between our screen width and our screen height \(\). In order to obtain the projected coordinates of a given point we just need to multiply the projection matrix by the original coordinates. The result will be another vector that will contain the projected version.
...
![Square coloured](.gitbook/assets/square_coloured.png)
...
![Transformations](.gitbook/assets/transformations.png)
