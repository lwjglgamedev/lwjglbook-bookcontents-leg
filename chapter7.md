...
![Cube coords](.gitbook/assets/cube_coords.png)
...
![Cube with no depth tests](.gitbook/assets/cube_no_depth_test.png)
...
![Cube with depth test](.gitbook/assets/cube_depth_test.png)
...
![Texture mapping](.gitbook/assets/texture_mapping.png)
...
![Texture coordinates](.gitbook/assets/texture_coordinates%20%281%29.png)
...
* `buffer`: The `ByteBuffer` that will hold the decoded image \(since each pixel uses four bytes its size will be 4  _width_  height\).
...
![Cube texture](.gitbook/assets/cube_texture.png)
...
![Texture coordinates front face](.gitbook/assets/cube_texture_front_face.png)
...
![Texture coordinates top face](.gitbook/assets/cube_texture_top_face.png)
...
![Cube with texture](.gitbook/assets/cube_with_texture.png)
